...
##运行机制 （此图说明了一切）
http://ww2.sinaimg.cn/large/6d49d34djw1etkp5vl682j20tx0h9410.jpg
...
http://ww1.sinaimg.cn/large/6d49d34djw1etkp6kfjd8j20ka0byta6.jpg

此处，选项框部分要根据项目需要添加相关界面。

顾名思义，notification Scene 就是三种界面中的通知界面，Glance Scene 就是三种界面中的Glance界面

OK，到此，Apple watch 工程已初步创建。
##project架构组成
http://ww2.sinaimg.cn/large/6d49d34djw1etkp7b9xqnj20gw0dlgoe.jpg
...
关于watch app storyboard的基本使用，了解这些就可以应对watch开发了。
其他，诸如动画的使用等情况，就项目要求具体情况具体对待吧。

### 关于WatchKit Extension ：
先看一下WatchKit Extension 的文件组成：（如图）

http://ww2.sinaimg.cn/large/6d49d34djw1etkp92vtslj207m07175k.jpg

前面提到watch的UI组成只包括三种界面，所以从字面上可以清楚的看出①代表了主界面的一系列视图控制器，②代表了自定义通知界面视图控制器，③则是代表了glance界面视图控制器。在这里简单提一下，关于glance界面，苹果官方规定，一个watch APP 只能有一个glance界面，用来显示一些重要信息，方便用户预览，另外glance 界面的布局格式，苹果做了严格规范，开发者只能套用苹果给出的几套模板，不可自定义样式。关于通知界面，大家课余研究吧，需要在
http://ww1.sinaimg.cn/large/6d49d34djw1etkp9ey2zuj209701z3ym.jpg 这个文件中做一些相关设置，本人对此界面研究不多。

下面着重来说一下 主界面视图控制器：

http://ww1.sinaimg.cn/large/6d49d34djw1etkpa05rgyj20ck07qmyg.jpg
...
http://ww4.sinaimg.cn/large/6d49d34djw1etkpaxhf2mj20mu06k41x.jpg
...
http://ww2.sinaimg.cn/large/6d49d34djw1etkpbbsaz7j20h50bwdiz.jpg
...
http://ww1.sinaimg.cn/large/6d49d34djw1etkpbmmxh6j20hq02wq3h.jpg 
http://ww1.sinaimg.cn/large/6d49d34djw1etkpbz888sj20na07d0wc.jpg

####iPhone向watch 端发送数据更新的通知方法（此处用的是达尔文通知，具体原理可搜索关键字--达尔文通知或者CFNotificationCenterGetDarwinNotifyCenter）
http://ww4.sinaimg.cn/large/6d49d34djw1etkpcgjlqmj20ii02rt9c.jpg
http://ww4.sinaimg.cn/large/6d49d34djw1etkpctedcoj20if0buq6g.jpg

*关于iPhone 与 watch之间的数据共享，Apple 建议还是在 iOS app 中完成，并通过 App Groups 进行数据共享，从而在 Watch Extension 中拿到这些数据。数据共享，单独开一篇文章说明。*
